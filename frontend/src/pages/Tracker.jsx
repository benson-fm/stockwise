...
export default function Tracker() {
  ...
  return (
    <div className="w-full min-h-dvh bg-black flex justify-center items-center flex-col gap-2">
      ...
      {/* Search Section */}
      <div className="flex flex-col py-20 px-36 h-full bg-[#111827] rounded-2xl text-white font-inter gap-10">
